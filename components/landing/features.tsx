...
const reports = [
  ...
  { ref: "EGB-2026-0355", label: "Blocked drainage", status: "Resolved" },
];

const card =
  "h-full rounded-2xl border bg-card p-6 transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5";
      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Reveal className="sm:col-span-2">
            <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-primary p-6 text-primary-foreground">
              ...
              <div className="mt-6 rounded-xl bg-white/10 p-4 ring-1 ring-white/15">
                <div className="flex flex-wrap gap-1.5">
                  {["Roads", "Waste", "Water", "Peace & order"].map(
                    (tag, i) => (
                      <span
                        key={tag}
              ...
              <div
                aria-hidden
                className="pointer-events-none absolute -right-16 -bottom-24 size-64 rounded-full bg-white/5 blur-2xl"
              />
            </div>
          </Reveal>
            ...
            <div className={card}>
              ...
              <div className="mt-5 space-y-2 text-xs">
                ...
                <p className="w-fit max-w-[85%] rounded-2xl rounded-bl-sm bg-muted px-3.5 py-2">
                  Register on the BIR portal, then confirm your email. I can
            ...
            <div className={card}>
              ...
              <div className="mt-5 space-y-2">
                {reports.map(({ ref, label, status }) => (
                  <div
                    key={ref}
                    className="rounded-xl bg-muted/60 px-3.5 py-2.5"
                  >
                      ...
                      <span
                        className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${
                          status === "Resolved"
                            ...
                            : "bg-brand-gold/20 text-brand-red dark:text-brand-gold"
                        }`}
                      >
                        {status}
                      </span>
          ...
          <Reveal delay={0.18} className="sm:col-span-2">
            <div className="h-full rounded-2xl border bg-muted/40 p-6 transition-colors hover:border-primary/40">
              <div className="flex h-full flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex shrink-0 items-center gap-4">
                  <div className="w-32 space-y-1.5 rounded-xl border bg-card p-3.5">
                    <p className="font-mono text-[9px] tracking-wider text-muted-foreground">
                      ORD-2026-118
                    </p>
                    {["w-full", "w-5/6", "w-full", "w-4/6", "w-3/6"].map(
                      (w, i) => (
                        <div
                          key={i}
                  ...
                  <div className="w-32 space-y-2 rounded-xl border bg-card p-3.5">
                    <p className="font-mono text-[9px] tracking-wider text-primary">
                      SUMMARY
                    </p>
