...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col bg-background text-foreground">
            ...
            <div className="rounded-2xl border bg-card shadow-xl shadow-primary/5">
              ...
              <div className="mx-4 mb-4 rounded-lg bg-primary p-3 text-xs text-primary-foreground">
                ...
                <p className="mt-1 opacity-80">
                  &ldquo;How do I get my digital TIN ID?&rdquo;
                </p>
              </div>
            </div>
            <div
        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 px-8 py-14 text-center text-white sm:px-16">
          ...
          <Link
            ...
            className={cn(
              ...
              "mt-8 gap-1.5 bg-white text-blue-700 hover:bg-blue-50",
            )}
          >
            Get Started
            <ArrowRight className="size-4" />
      ...
      <footer className="overflow-hidden px-6 pt-16 pb-6">
        <p
          aria-hidden
          className="bg-linear-to-b from-foreground/10 to-foreground/30 bg-clip-text text-center text-[13.5vw] leading-[0.85] font-bold tracking-tight whitespace-nowrap text-transparent select-none py-12"
        >
          eGovBridgeAI
        </p>
